package io.madhu.okta.application.repository;

import io.madhu.okta.application.SpringBootOktaApp;
import io.madhu.okta.application.config.Constants;
import io.madhu.okta.application.config.TestSecurityConfiguration;
import io.madhu.okta.application.config.audit.AuditEventConverter;
import io.madhu.okta.application.domain.PersistentAuditEvent;
...
import static io.madhu.okta.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
